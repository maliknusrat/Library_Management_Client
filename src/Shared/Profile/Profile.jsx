        ...
        <div className="w-full mx-auto my-10 lg:w-[70%] drop-shadow-lg bg-white">
            <form className="p-12">
                ...
                <div className="grid grid-cols-2 gap-5 place-content-center">
                    <div className="border flex justify-self-center">
                      <img className="w-[200px]" src={user[0]?.Image} alt="" />
                    </div>
                    <div className="space-y-3">
                    <label className="block">Name</label>
                    <div className="relative">
                        <input defaultValue={user[0]?.Name} className="p-3 block w-full pl-10 drop-shadow-lg outline-none" />
                    ...
                    <div className="relative">
                        <input  defaultValue={user[0]?.Email} className="p-3 block w-full pl-10 drop-shadow-lg outline-none" />
                        <span className="absolute top-1/4 left-2">< MdEmail  className="text-xl text-black"></MdEmail></span>
                    </div>
